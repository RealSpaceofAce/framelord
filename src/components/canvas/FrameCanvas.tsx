...
// =============================================================================
// Clean, brandable canvas with just the essentials1
// =============================================================================
...
import { getNodesForCanvas, createNode, updateNode, deleteNode, createConnection, getConnectionsForCanvas } from '../../stores/canvasStore';
...
export const FrameCanvas: React.FC<FrameCanvasProps> = ({ thread, onCanvasChange }) => {
  ...
  }, [selectedId, nodes, shapes, onCanvasChange]);
            ...
            if (shape.type === 'rectangle') {
              return (
                <Rect
                  ...
                  onClick={(e) => handleShapeClick(shape.id, shape.type, e)}
                  onDragMove={(e) => {
