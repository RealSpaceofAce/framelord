    ...
    <div className="mt-8 pt-6">
      ...
      >
        <div className="flex items-center gap-2 text-sm text-[#a1a1aa]">
          ...
          <span className="text-xs bg-[#0a0a0a] px-1.5 py-0.5 rounded">
            {backlinks.length}
          </span>
        </div>
          ...
          {backlinks.length === 0 ? (
            ...
            backlinks.map((note) => (
              <button
                ...
                className="w-full flex items-start gap-3 p-3 rounded-lg bg-[#0a0a0a] hover:bg-[#0a0a0a] transition-colors text-left"
              >
