      ...
      if (particlesRef.current && targetPositionsRef.current && rendererRef.current && sceneRef.current && cameraRef.current && velocitiesRef.current) {
        ...
        for (let i = 0; i < count; i++) {
          ...
          if (isMouseDownRef.current || forcedShape) {
            ...
            // PHYSICS TWEAKED FOR SLOW MOTION (configurable)
            const force = PARTICLE_CONFIG.formationForce;
            ...
            const noise = PARTICLE_CONFIG.dispersionNoise;
        ...
        if (isMouseDownRef.current || forcedShape) {
            ...
            if (forcedShape) {
                ...
                rotationRef.current.y += PARTICLE_CONFIG.autoRotationSpeed;
            }
        } else {
