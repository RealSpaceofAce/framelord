// =============================================================================
// SPLASH CURSOR — Fluid WebGL mouse trail effect for landing page
// =============================================================================
// Source: react-bits (https://github.com/DavidHDev/react-bits)
// Adapted for FrameLord: Removed 'use client' directive, added proper cleanup
//
// IMPORTANT: This component should ONLY be rendered on the public landing page.
// It must NOT appear on dashboard, contacts, notes, or any authenticated routes.
//
// Performance tuning (if needed for low-end devices):
// - Reduce DYE_RESOLUTION from 1024 to 512
// - Reduce SIM_RESOLUTION from 96 to 64
// =============================================================================
...
export default function SplashCursor({
  // Tuned for performance: reduced from 128/1440 defaults
  SIM_RESOLUTION = 96,
  DYE_RESOLUTION = 1024,
  ...
  // FrameLord brand blue tint for background
  BACK_COLOR = { r: 0, g: 0.1, b: 0.3 },
  TRANSPARENT = true
}: SplashCursorProps) {
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (!gl) {
        console.warn('[SplashCursor] WebGL not available');
